...
<details>
<summary><strong>물리/가상화 구성</strong></summary>
...
<details>
<summary><strong>VLAN과 IP 할당 규칙</strong></summary>

<a id="vlan과-ip-할당-규칙"></a>
...
<details>
<summary><strong>pfSense와 네트워크 경계</strong></summary>

<a id="pfsense와-네트워크-경계"></a>
...
<details>
<summary><strong>TrueNAS 기반 스토리지</strong></summary>

<a id="truenas-기반-스토리지"></a>
...
<details>
<summary><strong>Kubernetes 노드 배치</strong></summary>

<a id="kubernetes-노드-배치"></a>
...
<details>
<summary><strong>CI/CD 구성</strong></summary>
...
<details>
<summary><strong>구성 의도</strong></summary>
...
<details>
<summary><strong>3.1. CloudFront 중심의 public edge 통합</strong></summary>

<a id="31-cloudfront-중심의-public-edge-통합"></a>
...
<details>
<summary><strong>3.2. AWS와 온프레미스 workload 분리</strong></summary>

<a id="32-aws와-온프레미스-workload-분리"></a>
...
<details>
<summary><strong>3.3. pfSense 기반 하이브리드 VPN 구성</strong></summary>

<a id="33-pfsense-기반-하이브리드-vpn-구성"></a>
...
<details>
<summary><strong>3.4. PostgreSQL 이중화와 장애 전환</strong></summary>

<a id="34-postgresql-이중화와-장애-전환"></a>
...
- **포트 기반의 논리적 역할 분리:** 물리적 장비 구분이 아닌 논리적 기능 구분을 위해 포트를 나눕니다. 5432 포트는 쓰기(Write) 전용 채널, 5433 포트는 읽기(Read) 전용 채널로 매핑하여 HAProxy가 각 역할에 맞는 정상 서버로 패킷을 중계합니다. patorni REST API를 기반으로 라우팅됩니다.
...
<details>
<summary><strong>3.5. VESSL AI 기반 내부 LLM 추론 분리</strong></summary>

<a id="35-vessl-ai-기반-내부-llm-추론-분리"></a>
...
<details>
<summary><strong>3.6. Terraform record-only 운영 모델</strong></summary>

<a id="36-terraform-record-only-운영-모델"></a>
...
<details>
<summary><strong>3.7. Observability와 FinOps 문서화</strong></summary>

<a id="37-observability와-finops-문서화"></a>
...
<details>
<summary><strong>4.1. Harbor/Trivy 이미지 취약점 개선</strong></summary>

<a id="41-harbortrivy-이미지-취약점-개선"></a>
...
<details>
<summary><strong>4.2. ECR 이미지 용량 및 배포 효율 최적화</strong></summary>

<a id="42-ecr-이미지-용량-및-배포-효율-최적화"></a>
